    ...
    <body>
        <div class="body">
            ...
            <g:form action="address">
            	<g:hiddenField name="id" value="${shipinfo?.id}"/>
				...
				<fieldset>
					...
					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: 'addressLine', 'error')}"><label>Street address </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: 'addressLine')}" class="text" />
						</div>
					</div>

					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: 'city', 'error')}"><label>City </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: 'city')}" class="text" />
						</div>
					</div>
					
					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: '"postcode"', 'error')}"><label>Postcode </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: '"postcode"')}" class="text" />
						</div>
					</div>

					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: 'suburb', 'error')}"><label>Suburb </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: 'suburb')}" class="text" />
						</div>
					</div>
					
					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: 'state', 'error')}"><label>State </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: 'state')}" class="text" />
						</div>
					</div>
					
					<div class="form-row">
						<div class="form-value ${hasErrors(bean: shipinfo, field: 'contactPhone', 'error')}"><label>Contact Phone </label>
							<g:textField  size="32" name="fullname" value="${fieldValue(bean: shipinfo, field: 'contactPhone')}" class="text" />
						</div>	
					</div>
