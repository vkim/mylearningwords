            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orderItem.name.label" default="Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: orderItemInstance, field: "name")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orderItem.shipOrder.label" default="Ship Order" /></td>
                            
                            <td valign="top" class="value"><g:link controller="shipOrder" action="show" id="${orderItemInstance?.shipOrder?.id}">${orderItemInstance?.shipOrder?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orderItem.throwBox.label" default="Throw Box" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${orderItemInstance?.throwBox}" /></td>
